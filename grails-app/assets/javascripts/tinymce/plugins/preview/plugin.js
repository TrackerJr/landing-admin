...
tinymce.PluginManager.add('preview', function(editor) {
	...
	editor.addCommand('mcePreview', function() {
		...
		var width = $('#view-width').val() || 650;
		var height= $('#view-height').val() || 500;
		
		editor.windowManager.open({
			title: 'Preview',
			width: parseInt(editor.getParam("plugin_preview_width", width), 10),
			height: parseInt(editor.getParam("plugin_preview_height", height), 10),
